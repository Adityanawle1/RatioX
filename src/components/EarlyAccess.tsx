    ...
    <section id="early-access" className="py-24 md:py-32 border-t border-surface-border bg-background relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="font-mono text-sm text-muted-foreground text-center mb-12 max-w-lg leading-relaxed uppercase tracking-widest">
            // No credit card required to boot system. Live latency. Absolute precision.
          </p>

          <Link
            to={ctaHref}
            className="group relative overflow-hidden bg-foreground text-background font-mono text-xs md:text-sm uppercase tracking-widest px-10 py-5 font-semibold transition-colors duration-300 border border-transparent hover:border-amber w-full sm:w-auto text-center"
          >
